...
<section id='config' class='page hidden'><div class='page-head'><h1>Configuration</h1><p>PicoKeyApp Configuration panel: PHY, VID/PID, USB strings, LED, touch, and timeout settings.</p></div><div class='grid'><div class='card'><div class='card-head'><div class='card-title'>Device PHY</div><span class='pill'>read/write</span></div><div class='row'><button class='secondary' onclick='feature("config-read-phy")'>Read current PHY</button><button class='primary' onclick='feature("config-write-phy")'>Write PHY to device</button><button class='secondary' onclick='commission()'>Generate PHY blob</button></div><p class='note'>PHY blob generation works now. Direct device write needs exact PicoKeyApp slot/protocol port.</p></div><div class='card'><div class='card-title'>USB Identity</div><div class='stack'><label class='field'><span>VID:PID preset</span><select id='vidpidPreset'><option value='1050:0407:YubiKey 5'>YubiKey 5 (1050:0407)</option><option value='2e8a:10fe:Pico FIDO'>Pico FIDO (2E8A:10FE)</option><option value='1d50:619b:LibreKeys One'>LibreKeys One (1D50:619B)</option></select></label><label class='field'><span>Manufacturer</span><input id='manufacturer' value='Pol Henarejos'></label><label class='field'><span>Product</span><input id='productName' value='pico_fido'></label><button class='primary' onclick='feature("config-write-identity")'>Apply identity</button></div></div><div class='card'><div class='card-title'>LED</div><div class='stack'><label class='field'><span>Driver</span><select onchange='ledDriver.value=this.value'><option>ws2812</option><option>pico</option><option>pimoroni</option><option>neopixel</option><option>none</option></select></label><label class='field'><span>GPIO</span><input onchange='ledPin.value=this.value' type='number' value='22'></label></div></div><div class='card'><div class='card-title'>Touch / Timeout</div><div class='stack'><label class='field'><span>Touch timeout seconds</span><input type='number' value='15'></label><label class='field'><span>Presence timeout warning</span><input type='number' value='30'></label><button class='secondary' onclick='feature("config-test-pin-dialog")'>Test PIN dialog</button></div></div></div></section>
